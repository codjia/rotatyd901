...
<head>
    ...
    <!-- Timeline CSS -->
    <link href="{{asset('Portal/css/timeline.css')}}" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="{{asset('Portal/css/startmin.css')}}" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="{{asset('Portal/css/morris.css')}}" rel="stylesheet">
...
@yield('sidebar', view('back.Auth.layouts.sidenav'))
...
<script src="{{asset('Portal/js/raphael.min.js')}}"></script>
<script src="{{asset('Portal/js/morris.min.js')}}"></script>
<script src="{{asset('Portal/js/morris-data.js')}}"></script>
